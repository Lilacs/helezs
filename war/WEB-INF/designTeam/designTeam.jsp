...
<link href="css/designTeam.css" rel="stylesheet" media="all">
...
<title>菏泽和乐居装饰-设计团队-官方网站|菏泽装修|菏泽最好的装饰装修公司|菏泽装修公司|菏泽装修|菏泽家装|菏泽装修设计</title>
...
<body class="mainBody">
	...
	<div  class="contentArea">
		...
		<table width="100%" style="margin-top: 70px;">
			<tr>
				...
				<td width="33%" valign="top" align="center">
					...
					<p class="contentP2" align="left">
						设计师应该拥有来自各学科广泛的知识。不可以闭门造车，任何有可能发挥创造力的领域都应十分珍惜，用广泛的知识去解读设计你会发现更多。
					</p>
				</td>
			</tr>
		</table>
		...
		<table width="100%" style="margin-top: 70px;">
			<tr>
				<td width="33%" valign="top" align="center">
					<img src="images/designersPhoto/lvshifu.jpg" class="designerPic">
					<h1>吕师傅</h1>
					<h4>项目经理</h4>
					<p class="contentP" align="left">
						工种：木工<br/>
				...
				<td width="33%" valign="top" align="center">
					<img src="images/designersPhoto/yangshifu.jpg" class="designerPic">
					<h1>杨师傅</h1>
					<h4>项目经理</h4>
					<p class="contentP" align="left">
						工种：木工，电工<br/>
